...
public class NusantaraTower extends JPanel implements Runnable {
    ...
    private void startNewTower() {
        ...
        game.craneX = getTowerAreaCenter(w);
    ...
    private void prepareNextHangingBlock() {
        ...
        // Kalau sudah di lantai ke-10, pakai balok atap
        BufferedImage img = (game.towerStack.size() == 9) ? balokAtap : getImageForType(nextType);
    ...
    private void placeTowerInCity() {
        ...
        FinishedBuilding fb = new FinishedBuilding(new Point(city.nextCityPlot), game.towerStack.size(), top.type);
